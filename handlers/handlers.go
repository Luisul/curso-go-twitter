...
import (
	...
	"github.com/Luisul/curso-go-twitter/middlew"
	"github.com/Luisul/curso-go-twitter/routers"
	"github.com/gorilla/mux"
	"github.com/rs/cors"
)

/*Manejadores seteo puerto handle y escucha al servidor*/
func Manejadores() {
	...
	router.HandleFunc("/listaUsuario", middlew.ChequeoBD(middlew.ValidoJWT(routers.ListaUsuarios))).Methods("GET")
